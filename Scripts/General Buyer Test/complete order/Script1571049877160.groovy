...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Moscord - Product List/select_USDEURSGDGBP'), 'string:SGD', 
    true)
...
WebUI.click(findTestObject('Object Repository/Page_Moscord - Product List/span_(2)'))

WebUI.delay(10)

WebUI.waitForElementClickable(findTestObject('Page_Moscord - cart/button_Complete Order'), 0)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Page_Moscord - order-preview/button_Download order here'), 
    0)

WebUI.click(findTestObject('Object Repository/Page_Moscord - order-preview/button_Download order here'))
