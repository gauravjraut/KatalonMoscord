...
WebUI.click(findTestObject('Page_Moscord - Product List/i_Views_fa fa-eye'))

WebUI.delay(5)

WebUI.click(findTestObject('Page_Moscord - Product List/span_Create View'))
...
WebUI.click(findTestObject('Page_Moscord - Product List/a_Add view'))

WebUI.delay(5)

WebUI.setText(findTestObject('Page_Moscord - Product List/input_View Name_form-control ng-untouched ng-valid ng-dirty ng-valid-parse'), 
    'test')
...
WebUI.click(findTestObject('Page_Moscord - Bookmarks/span_Karissa Salonga'))
